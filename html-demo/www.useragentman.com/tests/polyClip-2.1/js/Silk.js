/*
 * Silk.js.  Similar to jQuery.aniamte(), but uses requestAnimationFrame
 * to perform GPU accelerated animations where possible. 
 * 
 * @requires: jshashtable 2.1 or higher. http://www.timdown.co.uk/jshashtable/index.html
 */
